 		...
 		if($('#tasas').is(':checked')){
 			 t=1;
 				...
 				if(check==1){
				 	...
				 	$('#detallado').hide();
				 	$('#acredita').show();
					$('#acredita').load('ajax.php?c=ConcentradoIVAProveedor&f=contenido&ejercicio='+ejercicio+'&delperiodo='+delperiodo+'&alperiodo='+alperiodo+'&proveedores='+proveedores+'&fechaimprecion='+fechaimprecion+'&t='+t+'&aplica='+aplica,function(){
					...
					$('#confi').hide();
				 	$('#detallado').hide();
				 	$('#acredita').show();
					$('#acredita').load('ajax.php?c=ConcentradoIVAProveedor&f=contenido&ejercicio='+ejercicio+'&inicio='+inicio+'&fin='+fin+'&proveedores='+proveedores+'&fechaimprecion='+fechaimprecion+'&t='+t+'&aplica='+aplica,function(){
						$('#nmloader_div',window.parent.document).hide();
					});
