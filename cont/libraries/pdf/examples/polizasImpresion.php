...
if($orientacion=='P'){
    $pdf = new MYPDF_V(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
}else{
    $pdf = new MYPDF_H(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
}*/
...
for ($i = 1; $i < $cuenta; $i++) {
    ...
    $html="$encabezado[0] $separada[$i] </tbody></table>"; //combinamos encabezado con cuentas
...
$pdf->Output($_POST['nombreDocu'].'.pdf', 'D');
