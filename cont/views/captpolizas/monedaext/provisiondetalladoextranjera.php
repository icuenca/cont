	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-10">
				...
				<form method="post" ENCTYPE="multipart/form-data" action="index.php?c=automaticasMonedaExt&f=guardaProvisionMultiple" id="formulario">
					<h4>Informacion Poliza</h4>
					<section>
						<div class="row">
							<div class="col-md-4">
						...
						<div class="row">
							...
							<div class="col-md-3 col-md-offset-1">
								<button type="button" name="Submit" class="btn btn-primary btnMenu" onclick="sele()">Previsualizar</button>
							</div>
						</div>
					</section>
								...
								<table id="datos" align="" cellpadding="2" border="0" class="table">
									...
									<tr>
										<td><?php echo $cli['conceptodetalle'][$c]  ?></td>
									     ...
									     <td align="center" ><?php echo number_format($cli['preciodetallemxn'][$c],2,'.',','); ?></td>
									
										 <td align="center" class="me">0.00</td>
									     <td align="center" class="me"><?php echo number_format($cli['preciodetalle'][$c],2,'.',','); ?></td>
									</tr>
						 			<?php $contdeta ++; }?>
									...
									<?php 	} ?>		
										...
										<td align="center" class="me">0.00</td>
										<td align="center" class="me" id="importe"><?php echo number_format($cli['abono2'],2,'.',',');?></td>
									 </tr>
									<?php } ?> 
									...
									<tr>
										...
										<?php } ?>
											...
											<td align="center" class="me">0.00</td>
											<td align="center" class="me" id="importeieps"><?php echo number_format($cli['ieps'],2,'.',',');?></td>
										<?php } ?>
										</tr>
										<!-- ISH -->
										<tr>
										...
										<td></td>
											...
											<td align="center" class="me">0.00</td>
											<td align="center" class="me"  id="importeish<?php echo $cont; ?>"><?php echo number_format($cli['ish'],2,'.',','); ?></td>
										<?php } ?>
										</tr>
										<!--FIN  ISH -->
									 <tr>
									     ...
									     <td align="center" class="me" id="total<?php echo $cont; ?>"><?php echo number_format($cli['cargo'],2,'.',','); ?></td>
									     <td align="center" class="me">0.00</td>
									     <td><?php 
									...
									<?php } ?>
										<td align="center" id="" name="total<?php echo $key.$cont; ?>"><?php echo number_format($cli['retenidosmxn'][$key],2,'.',','); ?></td>
									    <td align="center">0.00</td>
									    
									    <td align="center" class="me" id="total<?php echo $key.$cont; ?>" name="total<?php echo $key.$cont; ?>"><?php echo number_format($value,2,'.',','); ?></td>
									    <td align="center" class="me">0.00</td>
									...
									<tr>
										...
										<td align="center" id=""><?php echo number_format(floatval($prove['preciodetallemxn'][$c]),2,'.',''); ?></td>
								 		<td align="center">0.00</td>
								 		
										<td align="center" class="me" id="subtotalegre"><?php echo number_format(floatval($prove['preciodetalle'][$c]),2,'.',''); ?></td>
								 		<td align="center" class="me">0.00</td>
								 	</tr>
						 			<?php $contdeta ++; }?>
						 			<input type="hidden" value="<?php echo $c; ?>" id="contador<?php echo $cont; ?>"/>
									...
									<td align="center" class="me" id="importeegre"><?php if($prove['cargo2']){echo number_format($prove['cargo2'],2,'.','');}else{ echo 0;} ?></td>
									<td align="center" class="me">0.00</td>
									<?php } ?> 
									</tr>	
									<?php if($prove['ieps']>0){ ?>
									...
									<td align="center">0.00</td>
									<td align="center" class="me" id="importeiepsegre"><?php echo number_format($prove['ieps'],2,'.','');?></td>
									<td align="center" class="me">0.00</td>
									<?php } ?>
									</tr>
									<!-- ISH -->
									...
									<?php } ?>
										...
										<td align="center" class="me" id="importeishegre"><?php echo number_format(floatval($prove['ish']),2,'.',',');?></td>
										<td align="center" class="me">0.00</td>
									<?php } ?>
									</tr>
									<!--FIN  ISH -->
									...
									<td align="center" class="me">0.00</td>
									<td align="center" class="me" id="totalegre<?php echo $cont; ?>"><?php echo number_format(floatval($prove['abono']),2,'.',''); ?></td>
									<td>
									<?php 
									...
									<tr>
										...
										<td align="center" class="me">0.00</td>
									    <td align="center" class="me" id="total<?php echo $key; ?>" name="total<?php echo $key; ?>"><?php echo number_format(floatval($value),2,'.',','); ?></td>
										</tr>
									...
									<tfoot>
									<tr><td>
									<label>Concepto Poliza:</label><br>
...
$(function () {
        ...
        $("#datos tbody tr").each(function (index) //recorre todos los tr
        {
            $(this).children("td").each(function (index2) //en la fila actual recorremos los td
            {
                ...
                {
                    case 4: cargo += parseFloat($(this).text().replace(/,/gi,''));
                            break;
                    case 5: abono += parseFloat($(this).text().replace(/,/gi,''));
                            break;
                }
            })
        })
