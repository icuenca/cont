...
<head>
	...
	<script type="text/javascript" src="js/provisionext.js" ></script>
...
if(isset($_COOKIE['ejercicio'])){
	...
	$v=0;
		...
		if(isset($_SESSION['datosext']['cuentaClienteslista'])){
			
			$cuentacliente="<option value=0>--Seleccione--</option>";
			foreach($_SESSION['datosext']['cuentaClienteslista'] as $li){
			...
			foreach ($_SESSION['datosext']['cuentaProveelista'] as $pr){
	...
	<div class="row">
		...
		<div class="col-md-12">
			<div class="row">
				<div class="col-md-12">
					<h3 class="nmwatitles text-center">
						...
						<a  href='index.php?c=CaptPolizas&f=filtroAutomaticas&t=provision' onclick="" id='filtros'><img src="../../netwarelog/repolog/img/filtros.png"  border="0" title='Haga click aqu&iacute; para cambiar los filtros...'></a>
					</h3>
				</div>
			</div>
			...
			<section>
				...
				<div class="row">
					<div class="col-md-6">
						<label>Acorde a configuraci&oacute;n:</label><img src="images/reload.png" onclick="periodoactual()" title="Ejercicio y periodo de configuracion por defecto" style="vertical-align:middle;">
					</div>
					<div class="col-md-6">
			...
			<form method="post" ENCTYPE="multipart/form-data" action="index.php?c=automaticasMonedaExt&f=guardaProvisionMultiple" id="formulario" onsubmit="return sele()">
				...
				<section>
					<div class="row">
							...
							<div class="form-group>">
								...
								<select id="moneda" name="moneda" onchange="consultaTipoCambio(this.value)">
									...
									while($m = $moneda->fetch_assoc()){
										...
										<?php }else{ 
										$s=""; 
										if(isset($_SESSION['datosext']['moneda'])){
											if($_SESSION['datosext']['moneda'] == $m['coin_id']){ $s="selected"; }
										}
										?>
										
										<option value="<?php  echo $m['coin_id']?>" <?php echo $s; ?>><?php echo $m['description']." (".$m['codigo'].")"; ?></option>
									<?php }  }?>
								</select>
							</div>
						</div>
						<div class="col-md-3" id='consul' style='font-size:12px; color:blue; display: none;'>
							<label>Consultando...</label>
						</div>
						<div class="col-md-3">
							<div class="form-group>">
								...
								<select id="tipocambio" name="tipocambio">
									...
									if(isset($_SESSION['datosext']['tipocambio'])){
										if ($_SESSION['datosext']['tipocambio']==$row['tipo_cambio']){ $ti = "selected";}else{ $ti="";}
									}
						...
						<div class="col-md-3">
							<label style="color: red;">Si no selecciona tipo de cambio se tomara acorde a la fecha de la factura</label>
						</div>
					</div>
				</section>
				<h4>Selecci&oacute;n de facturas</h4>
				<section>
					<div class="row">
						<div class="col-md-4">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="table-responsive">          
			  				<table class="table table-bordered datos" id="datos" style="margin-bottom: 0;">
								<thead>
									<tr style="background-color:#999999;color:white;font-weight:bold;">
										
										<td align="center" width="15%">Concepto</td>
										<td align="center" width="25%">Cuenta</td>
										<td align="center" width="10%">Cargo MXN</td>
										<td align="center" width="10%">Abono MXN</td>
										<td align="center" width="10%">Cargo M.E.</td>
										<td align="center" width="10%">Abono M.E.</td>
										<td align="center" width="10%">%</td>
		  			...
		  			<div class="col-md-12">
						...
						<?php	 foreach($_SESSION['provisioncliente'] as $cliente){ 
									...
									<div class="row">
										<div class="col-md-12">
											<div class="table-responsive">
												<table id="tabla<?php echo $cont;?>"   class="table table-bordered datos" >
													<?php echo $head;?>
													<tbody>
													...
													<td align="center" width="1%" colspan="4"><?php echo $cli['referencia']; ?></td>
													<td>	<input type="button" id="agregar" value="+Prorrateo" title="Agregar Niveles Prorrateo" onclick="porra('tabla<?php echo $cont;?>',<?php echo $cont; ?>,<?php echo number_format($cli['abono'],2,'.','');?>,<?php echo $cli['tipo_cambio'];?>,<?php echo number_format($cli['abonomxn'],2,'.','');?>)"/></td>
													<td colspan="2"><?php 
													...
													<td><img src="images/eliminado.png" title="Eliminar Movimiento"  onclick="borra(<?php echo $cont; ?>,'provisioncliente');"/></td>
													 ...
													 <tr class="out" onmouseout="this.className='out'" onmouseover="this.className='over'" class="porrateo" >
														     ...
														     <td align="center">
														     	<label id="montomxn<?php echo $cont; ?>" name="montomxn<?php echo $cont; ?>" data-id="v<?php echo $cont; ?>v0">
														     	<?php echo number_format($cli['abonomxn'],2,'.',',');  ?>
														    		</label>
														     </td>
														     <!-- fin mxn -->
															 <td align="center" class="me">0.00</td>
														     <td align="center" class="me">
														     ...
														     <td id="input<?php echo $cont; ?>"><input  onkeyup="calculaprorrateo(this.value,<?php echo number_format($cli['abono'],2,'.',''); ?>,<?php echo $cont;?>,0,<?php echo $cli['tipo_cambio'];?>)" type="text" name="prorrateo<?php echo $cont; ?>[]" id="prorrateo<?php echo $cont; ?>" style="width:80px;display:none;color: black" class="inputtext<?php echo $cont; ?>" align="center" /></td>
														     <td align="center" id="">
													...
													<tr class="out" onmouseout="this.className='out'" onmouseover="this.className='over'">
															...
															<?php if($statusIEPS==1){
																	 if($statusIVAIEPS==1){ ?>
																	<td  class="" align="center">
																		<input type="button" id="ieps" name="ieps" title="Ir a asignacion de cuentas"  onclick="mandaasignarcuenta();"  class="nminputselect" style="width: 180px;" value="<?php  echo $iepspendientecobro[1]; ?>"/>
																	</td>
															<?php }else{?>
																	<script>
																		$(document).ready(function(){
															...
															<!-- mxn -->
																<td align="center">0.00</td>
																<td align="center" id=""><?php echo number_format($cli['iepsmxn'],2,'.',','); ?></td>
															<!-- fin mxn -->
																<td align="center" class="me">0.00</td>
																<td align="center" id="importeieps" class="me"><?php echo number_format($cli['ieps'],2,'.',','); $abonos+=$cli['ieps'];?></td>
																<td></td>
															...
															<td></td>
																<td class="" align="center"><!-- Cuenta para ISH -->
																	<?php if($statusRetencionISH==1){ ?>
																			<input type="button" id="ish" name="ish" title="Ir a asignacion de cuentas"  onclick="mandaasignarcuenta();" class="nminputselect" style="width: 180px;" value="<?php   echo $ishh[1]; ?>"/> 					
																	<?php }else{?>
																			<script>
																				$(document).ready(function(){
																...
																<!-- mxn -->
																<td align="center">0.00</td>
																<td align="center" id=""><?php echo number_format($cli['ishmxn'],2,'.',',');?></td>
																<!--fin mxn -->
																
																<td align="center" class="me">0.00</td>
																<td align="center" id="importeish<?php echo $cont; ?>" class="me"><?php echo number_format($cli['ish'],2,'.',','); $abonos+=$cli['ish'];?></td>
																<td></td>
													...
													if($statusIVA==1){
														if($statusIVAIEPS==1){ ?>
																	<td  class="" align="center">
																	<input style="width: 180px;" type="button" id="ivaingre" name="ivaingre<?php echo $cont; ?>" title="Ir a asignacion de cuentas" onclick="mandaasignarcuenta();" class="nminputselect" value="<?php  echo $ivapendientecobro[1];?>">
																	</td>
														<?php }else{?>
																<script>
																	$(document).ready(function(){
												...
												<?php } ?>	
														<!-- mxn -->
															<td align="center">0.00</td>
															<td align="center" id=""><?php echo number_format($cli['abono2mxn'],2,'.',',');?></td>
														<!--fin mxn -->

															<td align="center" class="me">0.00</td>
															<td align="center" id="importe" class="me"><?php echo number_format($cli['abono2'],2,'.',','); $abonos+=$cli['abono2'];?></td>
															<td></td>
														...
														<?php } ?> 
														 <tr class="out" onmouseout="this.className='out'" onmouseover="this.className='over'">
														     ...
														     <!-- mxn -->
														     <td align="center" id=""><?php echo number_format($cli['cargomxn'],2,'.',','); ?></td>
														     <td align="center">0.00</td>
														     <!-- fin mxn -->
														     <td align="center" id="total<?php echo $cont; ?>" class="me"><?php echo number_format($cli['cargo'],2,'.',','); $cargos+=$cli['cargo'];?></td>
														     <td align="center" class="me">0.00</td>
														     <td></td>
														...
														<tr class="out" onmouseout="this.className='out'" onmouseover="this.className='over'">
														 	...
														 	if($statusRetencionISH==1){
														 		...
														 		if($key=="IVA"){ ?>
															 		<td class="" align="center">
																		<input type="button" id="IVA" name="<?php echo $key.$cont;?>" onclick="mandaasignarcuenta();" class="nminputselect" style="width: 180px;" value="<?php  echo $ivaretenido[1]; ?>"/>
																	</td>	
														 <?php	} 
														 		if($key=="ISR"){?>
															 		<td class="" align="center">
																		<input type="button" id="ISR" name="<?php echo $key.$cont;?>" onclick="mandaasignarcuenta();" class="nminputselect" style="width: 180px;" value="<?php   echo $isrretenido[1]; ?>"/>
																	</td>	
														 <?php	}
															}else{?>
																<script>
														...
														<?php } ?>
														<!-- mxn -->
															<td align="center" id="" name=""><?php echo number_format($cli['retenidosmxn'][$key],2,'.',','); ?></td>
														    <td align="center">0.00</td>
														<!-- fin mxn -->
														    <td align="center" class="me" id="total<?php echo $key.$cont; ?>" name="total<?php echo $key.$cont; ?>"><?php echo number_format($value,2,'.',','); $cargos+=$value;?></td>
														    <td align="center" class="me">0.00</td>
														    <td></td>
				...
				<?php  				$cont++; 
														...
														<table id="tabla<?php echo $cont;?>" class="table table-bordered datos" >
															...
															<tr class="out" onmouseout="this.className='out'" onmouseover="this.className='over'">
																	...
																	<!-- mxn -->
																		...
																		<td align="center">0.00</td>
																	<!-- fin mxn -->
																		<td align="center" class="me" id="importeieps"><?php echo number_format($cli['ieps'],2,'.',','); $cargos+=$cli['ieps'];?></td>
																		<td align="center" class="me">0.00</td>
																		<td></td>
																		<td align="center" id="segieps<?php echo $cont; ?>" style="display: none">
																	     	 <select name='segmento<?php echo $cont; ?>[]' id='segmento<?php echo $cont; ?>' style='width: 100px;text-overflow: ellipsis;'  class="segme<?php echo $cont;?>">
																	...
																	<!-- mxn -->
																		...
																		<td align="center">0.00</td>
																	<!--fin mxn -->
																		<td align="center" class="me" id="importeish<?php echo $cont; ?>"><?php echo number_format($cli['ish'],2,'.',','); $cargos+=$cli['ish'];?></td>
																		<td align="center" class="me">0.00</td>
																		<td></td>
																		<td align="center" id="segish<?php echo $cont; ?>" style="display: none">
																	     	 <select name='segmento<?php echo $cont; ?>[]' id='segmento<?php echo $cont; ?>' style='width: 100px;text-overflow: ellipsis;'  class="segme<?php echo $cont;?>">
															...
															<?php } ?>	
																<!-- mxn -->
																	...
																	<td align="center">0.00</td>
																<!-- fin mxn -->
																	<td align="center" id="importe" class="me"><?php echo number_format($cli['abono2'],2,'.',','); $cargos+=$cli['abono2'];?></td>
																	<td align="center" class="me">0.00</td>
																	<td></td>
																	<td align="center" id="segiva<?php echo $cont; ?>" style="display: none">
																     	 <select name='segmento<?php echo $cont; ?>[]' id='segmento<?php echo $cont; ?>' style='width: 100px;text-overflow: ellipsis;'  class="segme<?php echo $cont;?>">
																...
																<?php } ?> 
																 <tr class="out" onmouseout="this.className='out'" onmouseover="this.className='over'">
																     ...
																     <!--fin mxn -->
																     <td align="center" class="me">0.00</td>
																     <td align="center" class="me" id="total<?php echo $cont; ?>"><?php echo number_format($cli['cargo'],2,'.',','); $abonos+=$cli['cargo'];?></td>
																     <td></td>
																	<td align="center" id="segnombre<?php echo $cont; ?>" style="display: none">
																     	 <select name='segmento<?php echo $cont; ?>[]' id='segmento<?php echo $cont; ?>' style='width: 100px;text-overflow: ellipsis;'  class="segme<?php echo $cont;?>">
																			<?php echo $segmento; ?>
																...
																<!-- mxn -->
																 ...
																 <!--fin mxn --> 
																	<td align="center" class="me">0.00</td>
																    <td align="center" class="me" id="total<?php echo $key.$cont; ?>" name="total<?php echo $key.$cont; ?>"><?php echo number_format($value,2,'.',','); $abonos+=$value;?></td>
																    <td></td>
																	<td align="center" id="seg<?php echo $key.$cont; ?>" style="display: none">
																     	 <select name='segmento<?php echo $cont; ?>[]' id='segmento<?php echo $cont; ?>' style='width: 100px;text-overflow: ellipsis;'  class="segme<?php echo $cont;?>">
																			<?php echo $segmento; ?>
						...
						<?php				$cont++; 
												...
												<div class="row">
													<div class="col-md-12">
														<div class="table-responsive">
															<table id="tabla<?php echo $cont;?>" class="table table-bordered datos" >
																...
																<tr style="background-color:#BDBDBD;color:#585858;font-weight:bold;">
																	...
																	<td align="center" width="1%" colspan="4"><?php echo $prove['referencia']; ?></td>
																	<td>	<input type="button" id="agregar" value="+Prorrateo" title="Agregar Niveles Prorrateo" onclick="porra('tabla<?php echo $cont;?>',<?php echo $cont; ?>,<?php echo number_format($prove['cargo'],2,'.','');?>,<?php echo $prove['tipo_cambio'];?>,<?php echo number_format($prove['cargomxn'],2,'.','');?>)"/></td>
																	<td colspan="2"><?php 
															...
															<?php	} ?>
													 			...
													 			<tr class="out" onmouseout="this.className='out'" onmouseover="this.className='over'" class="porrateo" >
																	...
																	<td align="center" id="">
																		<label id="montomxn<?php echo $cont; ?>" name="montomxn<?php echo $cont; ?>" data-id="v<?php echo $cont; ?>v0">
																     	<?php echo number_format(floatval($prove['cargomxn']),2,'.',','); ?>
																     	</label>
																	</td>
															 		<td align="center">0.00</td>
															 		<!-- fin mxn -->
																	<td align="center" id="subtotalegre" class="me">
																		<label id="montoprorra<?php echo $cont; ?>" name="montoprorra<?php echo $cont; ?>" data-valor="v<?php echo $cont; ?>v0">
																     	<?php echo number_format(floatval($prove['cargo']),2,'.',','); $cargos+=$prove['cargo']; ?>
																     	</label>
																	</td>
															 		<td align="center" class="me">0.00</td>
															 		<td id="input<?php echo $cont; ?>"><input  onkeyup="calculaprorrateo(this.value,<?php echo number_format($prove['cargo'],2,'.',''); ?>,<?php echo $cont;?>,0,<?php echo $prove['tipo_cambio'];?>)" type="text" name="prorrateo<?php echo $cont; ?>[]" id="prorrateo<?php echo $cont; ?>" style="width:80px;display:none;color: black" class="inputtext<?php echo $cont; ?>" align="center" /></td>
																	<td align="center" id="">
															     		<select name='segmento<?php echo $cont; ?>[]' id='segmento<?php echo $cont; ?>' style='width: 100px;text-overflow: ellipsis;'  class="segme<?php echo $cont;?>">
																			<?php echo $segmento; ?>
																		</select>
														...
														<?php if($statusIEPS==1){
														 	if($statusIVAIEPS==1){ ?>
																<td align="center">
																<input type="button" id="ieps" name="ieps<?php $cont;?>" title="Ir a asignacion de cuentas" onclick="mandaasignarcuenta();" class="nminputselect" style="width: 100%" value="<?php   echo $iepspendientepago[1]; ?>"/>
																</td>
														<?php }else{ ?>
																<script>
																$(document).ready(function(){
															...
															<?php }	
																...
																<td>
																<input type="button" id="ieps" name="ieps" title="Ir a asignacion de cuentas"  onclick="mandaasignarcuenta();"  class="nminputselect" style="width: 100%" value="<?php  echo $CuentaIEPSgasto[1]; ?>"/>
																</td>
														<?php } ?>
															<!-- mxn -->	
															<td align="center" id=""><?php echo number_format($prove['iepsmxn'],2,'.',','); ?></td>
															<td align="center">0.00</td>
															<!--fin mxn -->	
															<td align="center" class="me" id="importeiepsegre"><?php echo number_format($prove['ieps'],2,'.',','); $cargos+=$prove['ieps'];?></td>
															<td align="center" class="me">0.00</td>
															<td></td>
															<td align="center" id="segieps<?php echo $cont; ?>" style="display: none">
														     	 <select name='segmento<?php echo $cont; ?>[]' id='segmento<?php echo $cont; ?>' style='width: 100px;text-overflow: ellipsis;'  class="segme<?php echo $cont;?>">
													...
													<?php if($prove['ish']>0){ ?>
														...
														<td class="" align="center"><!-- Cuenta para ISH -->
														<?php if($statusRetencionISH==1){ ?>
																<input type="button" id="ish" name="ish" title="Ir a asignacion de cuentas"  onclick="mandaasignarcuenta();" class="nminputselect" style="width: 100%" value="<?php   echo $ishh[1]; ?>"/> 					
														<?php }else{?>
																<script>
																	$(document).ready(function(){
																		$("#ish<?php echo $cont;?>").select2({width : "130px"});
														...
														<!-- mxn -->
														<td align="center" id=""><?php echo number_format(floatval($prove['ishmxn']),2,'.',',');?></td>
														<td align="center">0.00</td>
														<!--fin mxn -->
														<td align="center" id="importeishegre" class="me"><?php echo number_format(floatval($prove['ish']),2,'.',',');$cargos+=$prove['ish'];?></td>
														<td align="center" class="me">0.00</td>
														<td></td>
														<td align="center" id="segish<?php echo $cont; ?>" style="display: none">
													     	 <select name='segmento<?php echo $cont; ?>[]' id='segmento<?php echo $cont; ?>' style='width: 100px;text-overflow: ellipsis;'  class="segme<?php echo $cont;?>">
												...
												<?php if($prove['cargo2']>0){ ?>
														<tr class="out" onmouseout="this.className='out'" onmouseover="this.className='over'">
															...
															if($statusIVA==1){ 
																if($statusIVAIEPS==1){ ?>
																<td   align="center">
																<input type="button" id="ivaingre" name="ivaingre<?php echo $cont; ?>" title="Ir a asignacion de cuentas" onclick="mandaasignarcuenta();" class="nminputselect" style="width: 100%;white-space: normal;" value="<?php   echo $ivapendientepago[1]; ?>"/>
																</td>
															<?php }else{?>
																	<script>
																		$(document).ready(function(){
															...
															<?php }
																...
																<td>
																<input type="button" id="ivaingre" name="ivaingre" title="Ir a asignacion de cuentas"  onclick="mandaasignarcuenta();"  class="nminputselect" style="width: 100%" value="<?php  echo $CuentaIVAgasto[1]; ?>"/>
																</td>
															<?php } ?>
															<!-- mxn -->
															<td align="center" id=""><?php if($prove['cargo2mxn']){echo number_format($prove['cargo2mxn'],2,'.',',');}else{ echo 0;} ?></td>
															<td align="center">0.00</td>
															<!--fin mxn -->
															<td align="center" class="me" id="importeegre"><?php if($prove['cargo2']){echo number_format($prove['cargo2'],2,'.',',');}else{ echo 0;}  $cargos+=$prove['cargo2'];?></td>
															<td align="center" class="me">0.00</td>
															<td></td>
															<td align="center" id="segiva<?php echo $cont; ?>" style="display: none">
														     	 <select name='segmento<?php echo $cont; ?>[]' id='segmento<?php echo $cont; ?>' style='width: 100px;text-overflow: ellipsis;'  class="segme<?php echo $cont;?>">
														...
														<tr class="out" onmouseout="this.className='out'" onmouseover="this.className='over'">
															...
															<!-- mxn -->
															<td align="center" >0.00</td>
															<td align="center"  id=""><?php echo number_format(floatval($prove['abonomxn']),2,'.',','); ?></td>
															<!--fin mxn -->
															<td align="center" class="me">0.00</td>
															<td align="center" class="me" id="totalegre<?php echo $cont; ?>"><?php echo number_format(floatval($prove['abono']),2,'.',','); $abonos+=$prove['abono'];?></td>
															<td></td>
															<td align="center" id="segnombre<?php echo $cont; ?>" style="display: none">
														     	 <select name='segmento<?php echo $cont; ?>[]' id='segmento<?php echo $cont; ?>' style='width: 100px;text-overflow: ellipsis;'  class="segme<?php echo $cont;?>">
																	<?php echo $segmento; ?>
												...
												<!-- retencion -->
														...
														<tr class="out" onmouseout="this.className='out'" onmouseover="this.className='over'">
																 	...
																 	if($statusRetencionISH==1){
																 		...
																 		if($key=="IVA"){ ?>
																	 		<td class="" align="center">
																				<input type="button" id="IVA" name="<?php echo $key.$cont;?>" onclick="mandaasignarcuenta();" class="nminputselect" style="width: 100%" value="<?php  echo $ivaretenido[1]; ?>"/>
																			</td>	
																 <?php	} 
																 		if($key=="ISR"){?>
																	 		<td class="" align="center">
																				<input type="button" id="ISR" name="<?php echo $key.$cont;?>" onclick="mandaasignarcuenta();" class="nminputselect" style="width: 100%" value="<?php   echo $isrretenido[1]; ?>"/>
																			</td>	
																 <?php	}
																	}else{?>
																		<script>
																...
																<!-- mxn -->
																<td align="center">0.00</td>
															    <td align="center" id="" name=""><?php echo number_format(floatval($prove['retenidosmxn'][$key]),2,'.',','); ?></td>
																<!--fin mxn -->
																<td align="center" class="me">0.00</td>
															    <td align="center" class="me" id="total<?php echo $key; ?>" name="total<?php echo $key; ?>"><?php echo number_format(floatval($value),2,'.',','); $abonos+=$value; ?></td>
																<td></td>
																<td align="center" id="seg<?php echo $key.$cont; ?>" style="display: none">
															     	 <select name='segmento<?php echo $cont; ?>[]' id='segmento<?php echo $cont; ?>' style='width: 100px;text-overflow: ellipsis;'  class="segme<?php echo $cont;?>">
																		<?php echo $segmento; ?>
							...
							<?php  				$cont++; 
									...
									// TIPO COMPORBANTE 4  IGUAL Q EGRESOS PERO AL REVEZ MOVIMI
									if($_SESSION['comprobante']==4){ 
									  foreach($_SESSION['poliprove'] as $pro){
												...
												<!--fin mxn -->	
													<td align="center" class="me">0.00</td>
													<td align="center" class="me" id="importeiepsegre"><?php echo number_format($prove['ieps'],2,'.',','); $abonos+=$prove['ieps']; ?></td>
													<td></td>
													<td align="center" id="segieps<?php echo $cont; ?>" style="display: none">
												     	 <select name='segmento<?php echo $cont; ?>[]' id='segmento<?php echo $cont; ?>' style='width: 100px;text-overflow: ellipsis;'  class="segme<?php echo $cont;?>">
															<?php echo $segmento; ?>
											...
											<?php if($prove['ish']>0){ ?>
												...
												<!--fin mxn -->
												<td align="center" class="me">0.00</td>
												<td align="center" class="me" id="importeishegre"><?php echo number_format(floatval($prove['ish']),2,'.',','); $abonos+=$prove['ish']; ?></td>
												<td></td>
												<td align="center" id="segish<?php echo $cont; ?>" style="display: none">
											     	 <select name='segmento<?php echo $cont; ?>[]' id='segmento<?php echo $cont; ?>' style='width: 100px;text-overflow: ellipsis;'  class="segme<?php echo $cont;?>">
														<?php echo $segmento; ?>
										...
										<?php if($prove['cargo2']>0){ ?>
											...
											<?php 	} ?>
													...
													<!--fin- mxn -->
													<td align="center" class="me">0.00</td>
													<td align="center" class="me" id="importeegre"><?php if($prove['cargo2']){echo number_format($prove['cargo2'],2,'.',',');}else{ echo 0;} $abonos+=$prove['cargo2']; ?></td>
													<td></td>
													<td align="center" id="segiva<?php echo $cont; ?>" style="display: none">
												     	 <select name='segmento<?php echo $cont; ?>[]' id='segmento<?php echo $cont; ?>' style='width: 100px;text-overflow: ellipsis;'  class="segme<?php echo $cont;?>">
															<?php echo $segmento; ?>
												...
												<tr class="out" onmouseout="this.className='out'" onmouseover="this.className='over'">
													...
													<td align="center">0.00</td>
													<!--fin mxn -->
													<td align="center" class="me" id="totalegre<?php echo $cont; ?>"><?php echo number_format(floatval($prove['abono']),2,'.',','); $cargos+=$prove['abono'];?></td>
													<td align="center" class="me">0.00</td>
													<td></td>
													<td align="center" id="segnombre<?php echo $cont; ?>" style="display: none">
												     	 <select name='segmento<?php echo $cont; ?>[]' id='segmento<?php echo $cont; ?>' style='width: 100px;text-overflow: ellipsis;'  class="segme<?php echo $cont;?>">
										...
										<!-- retencion -->
												...
												<tr class="out" onmouseout="this.className='out'" onmouseover="this.className='over'">
														...
														<?php } ?>
														<!-- mxn -->
														 <td align="center" id="" name=""><?php echo number_format(floatval($prove['retenidos'][$key]),2,'.',','); ?></td>
														<td align="center">0.00</td>
														<!--fin mxn -->
													    <td align="center" class="me" id="total<?php echo $key; ?>" name="total<?php echo $key; ?>"><?php echo number_format(floatval($value),2,'.',','); $cargos+=$value; ?></td>
														<td align="center" class="me">0.00</td>
														<td></td>
														<td align="center" id="seg<?php echo $key.$cont; ?>" style="display: none">
													     	 <select name='segmento<?php echo $cont; ?>[]' id='segmento<?php echo $cont; ?>' style='width: 100px;text-overflow: ellipsis;'  class="segme<?php echo $cont;?>">
