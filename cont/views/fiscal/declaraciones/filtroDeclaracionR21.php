	...
	<div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-10">
                <h3 class="nmwatitles text-center">Declaracion R21Impuesto al Valor Agregado</h3>
                <section id='info'>
                	<div class="row">
	                    <div class="col-md-12">
	                ...
	                <div class="row">
	                    <div class="col-md-12">
	                    	...
	                    	<input type="checkbox" class="nminputcheckbox" id="acr_iva" onclick="check();" >
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="col-md-12">
	                        <label>Incluir el IVA pagado no acreditable:</label>
	                    	<input type="checkbox" class="nminputcheckbox" id="inc_iva" >
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="col-md-12">
	                        <label>Usar Proporcion:</label>
	                    	<select id="prop_select" class="form-control">
	                ...
	                <div class="row">
	                    <div class="col-md-12">
	                    	...
	                    	<input  type="text" class="form-control" id="prop" value="0.0000">
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="col-md-12">
	                        <label>Monto acreditable derivado del ajuste:</label>
	                    	<input  type="text" class="form-control" id="cant1" value="0">
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="col-md-12">
	                        <label>Cantidad actualizada a reintegrarse:</label>
	                    	<input  type="text" class="form-control" id="cant2" value="0">
	                    </div>
	                </div>
	                <section id='ai'>
	                	<div class="row">
		                    <div class="col-md-12">
		                        <label>Otras Cantidades a cargo:</label>
		                    	<input type="text" class="form-control" id="cant3" value="0" disabled="">
		                    </div>
		                </div>
		                <div class="row">
		                    <div class="col-md-12">
		                        <label>Otras cantidades a favor:</label>
		                    	<input  type="text" class="form-control" id="cant4" value="0" disabled="">
		                    </div>
		                </div>
	                </section>
	                <div class="row">
	                    <div class="col-md-12">
	                        <label>Devolucion inmediata obtenida:</label>
	                    	<input  type="text" class="form-control" id="cant5" value="0">
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="col-md-12">
	                        <label>Acreditamientos de periodos anteriores:</label>
	                    	<input  type="text" class="form-control" id="cant6" value="0">
	                    </div>
	                </div>
	                <div class="row">
	                    <div class="col-md-12">
	                        <label>IEPS Acreditable:</label>
	                    	<input  type="text" class="form-control" id="cant7" value="0">
	                    </div>
	                </div>
	                <section id='ai1'>
	                	<div class="row">
		                    <div class="col-md-12">
		                        <label>IVA retenido al contribuyente:</label>
		                    	<input type="text"  class="form-control" value="0" id="retenidocontri" disabled="" >
		                    </div>
		                </div>
	                </section>
	                <div class="row">
