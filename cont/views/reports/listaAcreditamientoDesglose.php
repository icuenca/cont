...
<div class="container">
	<div class="row">
		...
		<div class="col-md-10">
			<h3 class="nmwatitles text-center">Lista de Acreditacion Desglose de IVA / <a href='index.php?c=reports&f=listaAcreditamientoProveedores'>Ir a Proveedores</a></h3>
			<div class="row">
