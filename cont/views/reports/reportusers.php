...
<div class="container">
	<div class="row">
		...
		<div class="col-md-4 col-sm-10">
			<h3 class="nmwatitles text-center">Reporte de Usuarios</h3>
			<form name='mov' method='post' id='info' action='index.php?c=Report_User&f=reportusers_despues' onsubmit='return valida(this)'>
				<!-- fecha antes -->
				<div class="row">
					<div class="col-md-12">
						<label>Del:</label><br>
